...
# ADR-0021: Ordinary user-session Codex execution profile
...
ADR-0021 without changing the execution contract. The original accepted branch
...
The former branch identifier is superseded by ADR-0021 for ordinary-session
