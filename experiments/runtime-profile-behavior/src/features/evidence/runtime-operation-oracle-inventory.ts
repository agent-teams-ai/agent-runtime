export const RUNTIME_OPERATION_ORACLE_INVENTORY = [
  ...
  { caseId: "cross-axis-transitions", examples: [
    ...
    { id: "allow-terminal-with-complete-closure", check: "cross_axis_transition", facts: ["transition_terminal_open_final_with_closure","admission_fenced","output_fenced","reconciliation_clear","execution_terminated","containment_satisfied","all_manifest_entries_satisfied"], expected: {"decision":"accept","code":"accepted"} },
    { id: "allow-terminal-not-started-with-complete-closure", check: "cross_axis_transition", facts: ["transition_terminal_open_final_not_started_with_closure","admission_fenced","output_fenced","reconciliation_clear","execution_not_started","containment_satisfied","all_manifest_entries_satisfied"], expected: {"decision":"accept","code":"accepted"} },
