export const RUNTIME_OPERATION_ORACLE_INVENTORY = [
  ...
  { caseId: "binary-revision-semantic-retention", examples: [
    { id: "root-before-provider-or-effect-work", check: "binary_revision_retention", facts: ["binary_revision_root_established","provider_or_effect_work_requested"], expected: {"decision":"accept","code":"accepted"} },
    { id: "work-without-semantic-root", check: "binary_revision_retention", facts: ["provider_or_effect_work_requested"], expected: {"decision":"reject","code":"semantic_root_required"} },
    { id: "session-release-before-root-establishment", check: "binary_revision_retention", facts: ["session_assignment_release_requested","provider_or_effect_work_requested"], expected: {"decision":"reject","code":"semantic_root_establishment_race"} },
    ...
    { id: "closed-operation-releases-root", check: "binary_revision_retention", facts: ["binary_revision_root_established","terminal_write_once","effect_closure_write_once","durable_revision_independent_projection"], expected: {"decision":"accept","code":"semantic_root_released"} },
    { id: "exact-release-replay-is-idempotent", check: "binary_revision_retention", facts: ["binary_revision_root_established","terminal_write_once","effect_closure_write_once","durable_revision_independent_projection","release_exact_replay"], expected: {"decision":"accept","code":"semantic_root_released"} },
    ...
    { id: "gc-with-zero-semantic-roots", check: "binary_revision_retention", facts: ["gc_requested","zero_semantic_roots"], expected: {"decision":"accept","code":"binary_revision_gc_allowed"} },
    ...
    { id: "semantic-root-does-not-authorize-dispatch", check: "binary_revision_retention", facts: ["binary_revision_root_established","dispatch_requested"], expected: {"decision":"reject","code":"root_not_execution_authority"} },
