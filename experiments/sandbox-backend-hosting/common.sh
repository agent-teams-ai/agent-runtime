...
OPEN_SANDBOX_SDK_SPEC=${OPEN_SANDBOX_SDK_SPEC:-opensandbox==0.1.15}
OPEN_SANDBOX_SERVER_SPEC=${OPEN_SANDBOX_SERVER_SPEC:-opensandbox-server==0.2.2}
export OPEN_SANDBOX_SDK_SPEC OPEN_SANDBOX_SERVER_SPEC
