...
import {snapshotDockerEngineCall, snapshotDockerEnginePolicy} from "../adapters/outbound/host-custody/docker/engine/docker-boundary-snapshot.js";
...
export const selectNodeDockerRoute = <P extends Preparation>(recipe: Readonly<{route: Route; preparation: P}>, binding: Binding, policy: string,
