import { NodeProviderProcessCustodyCore } from "../../../../dist/features/contained-agent-turn/adapters/outbound/host-custody/node-provider-process-custody-core.js";
import { CODEX_APP_SERVER_DARWIN_ARM64_TUPLE as tuple } from "../../../../dist/features/contained-agent-turn/adapters/outbound/codex-app-server/codex-app-server-platform-tuple.js";
import { createDarwinCodexRouteEnforcement, type DarwinCodexRouteEnforcementInput } from "../../../../dist/composition.js";
...
export const darwinRouteFixture = () => {
  ...
  const input: DarwinCodexRouteEnforcementInput = {
    ...
    owner: {hostCustody, hostBootId: "boot:synthetic", hostInstanceId: "host:synthetic",
    ...
    preparation: {hostCustody, durableRoot: {path: "/synthetic-absent-durable", dev: "1", ino: "2"},
      ...
      tmpDir: "/synthetic-absent-tmp", session: egress.ports, limits: egress.operation.limits,
  ...
  return {input, tuple, egress, resolves: () => resolves, mint: () => createDarwinCodexRouteEnforcement(input)};
};
