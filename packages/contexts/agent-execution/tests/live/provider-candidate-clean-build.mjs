...
// Trust boundary: separately qualified tools in a cooperative checkout.
...
export const verifyCleanBuild = async (snapshot, qualification) => {
  qualification = trustedToolchainQualification(qualification);
