...
test(`real PA owner and Host retry failed ${boundary} without repeating successful destructive work`, async () => {
  ...
  await assert.rejects(first, /ORDINARY_PA_UNAVAILABLE/);
