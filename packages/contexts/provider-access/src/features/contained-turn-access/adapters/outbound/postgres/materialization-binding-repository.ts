import type { ContainedTurnProviderAccessRepository } from "../../../application/ports/outbound/provider-access-binding-repository.js";
...
/** Trusted PA composition projection. One operation's scope digest is fixed by its owner. */
export const createMaterializationBindingRepository = (
  ...
  Object.freeze(owner);
  return Object.freeze<ContainedTurnProviderAccessRepository>({
