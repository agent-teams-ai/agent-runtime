...
const REVIEWED_OUT_OF_SCOPE = Object.freeze(["Embedded Runtime", "Runtime Security", "Module Kit", "experiments", "tooling other than scripts/architecture/check-feature-modules.mjs"]);
const REVIEWED_FEATURES = Object.freeze({ "runtime-installation-discovery": { root: "packages/contexts/agent-execution/src/features/runtime-installation-discovery", roles: ["contracts", "application", "adapters", "composition"] }, "contained-agent-turn": { root: "packages/contexts/agent-execution/src/features/contained-agent-turn", roles: STANDARD_ROLES }, "contained-turn-access": { root: "packages/contexts/provider-access/src/features/contained-turn-access", roles: STANDARD_ROLES }, "stable-filesystem-custody": { root: "packages/platform/filesystem-custody/src/features/stable-filesystem-custody", roles: ["contracts", "adapters"] }, "codex-configuration-inspection": { root: "packages/contexts/runtime-configuration/src/features/codex-configuration-inspection", roles: ["contracts", "application", "adapters", "composition"] }, "claude-code-configuration-inspection": { root: "packages/contexts/runtime-configuration/src/features/claude-code-configuration-inspection", roles: ["contracts", "application", "adapters", "composition"] } });
