...
export const traces = Object.freeze({
  ...
  invocations: Object.freeze({
    claudeCode: Object.freeze([
      Object.freeze({
        owner: "embedded-runtime",
        path: "packages/apps/embedded-runtime/src/features/contained-turn-runtime-access/contracts/runtime-access.ts",
        symbols: Object.freeze(["RuntimeAccessHandle", "ClaudeCodeRuntimeSetupQueries"]),
      }),
      Object.freeze({
        owner: "embedded-runtime",
        path: "packages/apps/embedded-runtime/src/features/setup-inspection-planning/adapters/build-claude-code-setup-view.ts",
    ...
    codex: Object.freeze([
      ...
      Object.freeze({
        owner: "embedded-runtime",
        path: "packages/apps/embedded-runtime/src/features/setup-inspection-planning/adapters/build-codex-setup-view.ts",
