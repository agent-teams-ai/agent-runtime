...
const sites = [
  ...
  ...[36, 46, 58].map(line => ["package/live/linux-codex-live-admin-route.test.ts", line, 34, x64, "linux-x64"]),
  ["package/live/linux-codex-node-selection.test.ts", 186, 187, x64, "linux-x64"],
  ["package/live/linux-codex-node-selection.test.ts", 213, 214, x64, "linux-x64"],
  ["package/live/linux-codex-node-selection.test.ts", 241, 242, x64, "linux-x64"],
