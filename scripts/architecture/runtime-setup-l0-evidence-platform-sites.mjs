...
const sites = [
  ...
  ["helpers/assembly-direct-reference.ts", 147, 148, darwin, "darwin-arm64"],
  ...
  ["live/linux-codex-node-selection.test.ts", 214, 215, x64, "linux-x64"],
  ["live/linux-codex-node-selection.test.ts", 242, 243, x64, "linux-x64"],
  ["live/linux-codex-live-canary-config.test.ts", 24, 25, x64, "linux-x64"],
