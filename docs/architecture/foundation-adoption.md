...
| unified documentation protocol | adoption prepared | Portable profile v3 and Authoring profile v3, strict frozen-document sidecar, executable portable Skill, and byte-preservation gate; published Foundation 1.2.0 / Docs 0.6.0 / managed adapter 0.2.5 are pinned in the manifest and registry lockfile. Qualified stable19 integration and managed state were produced by the supported stable18 source-owner upgrade; required current-head CI and central admission remain release gates |
