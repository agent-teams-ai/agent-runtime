...
| unified documentation protocol | adoption prepared | Portable profile v3 and Authoring profile v3, strict frozen-document sidecar, executable portable Skill, and byte-preservation gate; projected Foundation 1.1.0 / Docs 0.6.0 pins await final archive SRI and lock generation. Historical integration remains unchanged pending authentic qualified Cohort v2 and installed qualification |
