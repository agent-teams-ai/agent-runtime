...
| unified documentation protocol | adoption prepared | Portable profile v3 and Authoring profile v3, strict frozen-document sidecar, executable portable Skill, and byte-preservation gate; published Foundation 1.2.0 / Docs 0.6.0 / managed adapter 0.2.5 are pinned in the manifest and registry lockfile. Main stable18 integration and state remain unchanged; this package upgrade awaits qualified stable19 evidence and installed qualification |
