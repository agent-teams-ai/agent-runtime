...
| unified documentation protocol | stable23 installed | Portable profile v3, strict frozen-document sidecar, executable portable Skill and byte-preservation gate; published Foundation 1.5.1 / Docs 0.6.0 / managed adapter 0.2.8 are pinned in the manifest and registry lockfile; the retained stable23 managed-state record preserves its historical 1.3.3 cohort identity |
