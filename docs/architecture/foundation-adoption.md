...
| unified documentation protocol | adoption prepared | Portable profile v3 and Authoring profile v3, strict frozen-document sidecar, executable portable Skill, and byte-preservation gate; published Foundation 1.1.0 / Docs 0.6.0 / managed adapter 0.2.1 are pinned in the manifest and registry lockfile. Historical integration remains unchanged pending authentic qualified Cohort v2 and installed qualification |
