...
ADR-0017 through ADR-0021, excluding proposed ADR-0006, proposed ADR-0016, and the unassigned ADR
...
- [ADR-0021: Ordinary user-session Codex execution profile](decisions/0021-ordinary-user-session-codex-execution-profile.md) accepts the ordinary contract; implementation and qualification remain pending.
