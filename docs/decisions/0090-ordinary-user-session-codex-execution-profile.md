...
# ADR-0090: Ordinary user-session Codex execution profile
...
## Pre-merge identifier reconciliation

Main assigned ADR-0020 to Runtime Configuration activation in PR #133 while
this ordinary-session decision was still on PR #156. This canonical copy uses
ADR-0090 without changing the execution contract. The original accepted branch
bytes remain in [the retained decision](../../architecture/decisions/evidence/ordinary-session-adr0020-premerge.md)
with SHA-256 `1cd51ba204d7de2dd085913afde8e9349104895e1ad607c10cfe769eaeb0a35e`.
The former branch identifier is superseded by ADR-0090 for ordinary-session
composition; canonical ADR-0020 continues to govern Runtime Configuration.

Runtime Security subsequently claimed canonical ADR-0021 in PR #134, and
PR #135 already reserves ADR-0022. Ordinary-session therefore reserves
ADR-0090 for this delivery to avoid further collisions with that concurrent
activation series. The intermediate accepted branch copy is retained
[as exact evidence](../../architecture/decisions/evidence/ordinary-session-adr0021-premerge.md)
with SHA-256 `421a30eab66bd177a8a68e603d9a005e4ec946c3dc2beb8a0e9b48ad02f867fa`. No execution-profile semantics change.
